...
public class AVChatController {
    ...
    public void doCalling(final String account, final AVChatType avChatType, final AVChatControllerCallback<AVChatData> callback) {
        ...
        AVChatManager.getInstance().call2(account, avChatType, notifyOption, new AVChatCallback<AVChatData>() {
            ...
            public void onFailed(int code) {
                ...
                if (code == ResponseCode.RES_FORBIDDEN) {
                    ...
                    Toast.makeText(context, "发起通话失败, errCode: " + code + ", tel: " + account, Toast.LENGTH_SHORT).show();
                }
